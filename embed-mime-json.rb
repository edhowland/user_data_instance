#!/usr/bin/env ruby
# embed-mime-json.rb - read JSON file, replace user_data field with contents of MIME multipart file
...
parser = OptionParser.new do |opt|
  opt.banner = 'embed-mime-json embeds MIME multipart file in user_data field in input JSON'
  opt.separator ''
